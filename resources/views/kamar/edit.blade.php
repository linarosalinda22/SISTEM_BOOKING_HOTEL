    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('kamar.update', $kamar) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nomor_kamar" value="{{ old('nomor_kamar', $kamar->nomor_kamar) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('nomor_kamar') border-red-500 @enderror">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="lantai" value="{{ old('lantai', $kamar->lantai) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('lantai') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <select name="status_kamar" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('status_kamar') border-red-500 @enderror">
                        ...
                        <option value="Maintenance" {{ old('status_kamar', $kamar->status_kamar) == 'Maintenance' ? 'selected' : '' }}>Maintenance</option>
                    </select>
